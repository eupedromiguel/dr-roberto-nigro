...
export default function GerenciarSlots() {
  ...
  function handleSelecionarMedico(e) {
    ...
    if (id) {
      // Redireciona para a agenda do médico (slots)
      navigate(`/medico/agenda/${id}`);
    }
  }

  return (
    <div className="max-w-lg mx-auto p-6 text-white">
      <h2 className="text-2xl font-semibold mb-4">Gerenciar Slots</h2>
        ...
        <>
          ...
          <div className="relative w-full">
            <select
              ...
              className="appearance-none w-full bg-gray-800 border border-gray-700 rounded-md px-3 py-2 text-gray-100 focus:outline-none focus:ring-2 focus:ring-yellow-400 pr-8"
            >
